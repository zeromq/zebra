...
TARGET = $$qtLibraryTarget(qml_zebra)
uri = QmlZebra
...
android {
  # Use a default value assuming the zebra project sits outside this one
  isEmpty(ZEBRA_ROOT) {
    ZEBRA_ROOT = $$clean_path($$PWD/../..)
  }
  !exists($$ZEBRA_ROOT) {
    error(The ZEBRA_ROOT directory does not exist: $$ZEBRA_ROOT)
  }
