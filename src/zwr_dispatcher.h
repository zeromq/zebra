...
//  @interface
//  Create new zwr_dispatcher actor instance. The dispatcher forwards messages
...
//
//  Destroy zwr_dispatcher instance. This destroys the the endpoint and stops any
//  message flow between clients and handlers:
//
//      zactor_destroy (&dispatcher);
//
//  Note that all zwr_dispatcher commands are synchronous, so your application always
